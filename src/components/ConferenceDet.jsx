...
export class ConferenceDet extends Component {
  ...
  render() {
    return (
      <div className="m-4">
       <p style={{fontSize: 18, textAlign: 'justify'}}> <strong>International Conference on Mathematical Analysis and Application in Modeling (ICMAAM 2023) </strong>is aimed to bring researchers and professionals to discuss recent developments in Pure and Applied mathematics and their applications in Mathematical Modeling, in order to create a professional knowledge exchange platform between mathematicians. The Thrust area of the conference includes but is not limited to:
       </p>
